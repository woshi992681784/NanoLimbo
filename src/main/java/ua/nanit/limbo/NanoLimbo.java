...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "d868d7d0-e304-4dfb-b446-31809e9c8fa1"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("S5_PORT", "25607");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "25607");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "25402");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("CHAT_ID", "6260501117");            // telegram chat id,节点推送到telegram使用
        envVars.put("BOT_TOKEN", "7505844633:AAH799DXl9LXcyWOBGSnYcdWJuSal6dBaLA");          // telegram bot token,节点推送到telegram使用
        envVars.put("CFIP", "cdns.doon.eu.org");      // 优选域名或获选ip
        envVars.put("CFPORT", "443");          // 优选域名或获选ip对应端口
        envVars.put("NAME", "aaa");               // 节点备注名称
