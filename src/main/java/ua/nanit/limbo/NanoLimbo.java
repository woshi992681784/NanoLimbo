...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "b7d2f68c-64ca-4f25-ae3a-d5b5f130fc81"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("TUIC_PORT", "24814");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
